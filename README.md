...
The smart contract derives to the basic, standardized Token contract Token.sol and used for the management of tokens by a client smart contract (the dao). The Dao Account Manager contains the balance of the Dao. An account manager smart contract is also created for each contractor.
